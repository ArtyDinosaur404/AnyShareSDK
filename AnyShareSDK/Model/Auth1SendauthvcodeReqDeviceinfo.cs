...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Auth1SendauthvcodeReqDeviceinfo :  IEquatable<Auth1SendauthvcodeReqDeviceinfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Auth1SendauthvcodeReqDeviceinfo" /> class.
        /// </summary>
        ...
        /// <param name="version">客户端程序的版本  Windows： 5.0.11.253形式（主版本号，小版本号，修订号，构建号）  IOS：2.3.1.1  Android：4.2.2.222.</param>
        public Auth1SendauthvcodeReqDeviceinfo(string name = default(string), long? ostype = default(long?), string devicetype = default(string), string udid = default(string), string version = default(string))
        {
            this.Name = name;
            this.Ostype = ostype;
        ...
        /// </summary>
        /// <value>客户端程序的版本  Windows： 5.0.11.253形式（主版本号，小版本号，修订号，构建号）  IOS：2.3.1.1  Android：4.2.2.222</value>
        ...
        {
            return this.Equals(input as Auth1SendauthvcodeReqDeviceinfo);
        }

        /// <summary>
        /// Returns true if Auth1SendauthvcodeReqDeviceinfo instances are equal
        /// </summary>
        /// <param name="input">Instance of Auth1SendauthvcodeReqDeviceinfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Auth1SendauthvcodeReqDeviceinfo input)
        {
            if (input == null)
                return false;
