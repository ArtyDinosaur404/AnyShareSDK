...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetpendingapprovalsResApplyinfoType6 :  IEquatable<AuditGetpendingapprovalsResApplyinfoType6>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType6" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetpendingapprovalsResApplyinfoType6() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType6" /> class.
        /// </summary>
        ...
        public AuditGetpendingapprovalsResApplyinfoType6(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), string sharername = default(string), long? createdate = default(long?), AuditGetapplysResApplyinfoType6AllOfDetail detail = default(AuditGetapplysResApplyinfoType6AllOfDetail))
        {
        ...
        public AuditGetapplysResApplyinfoType6AllOfDetail Detail { get; set; }
        ...
        {
            return this.Equals(input as AuditGetpendingapprovalsResApplyinfoType6);
        }

        /// <summary>
        /// Returns true if AuditGetpendingapprovalsResApplyinfoType6 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetpendingapprovalsResApplyinfoType6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetpendingapprovalsResApplyinfoType6 input)
        {
            if (input == null)
                return false;
