...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType18 :  IEquatable<MessageGetResMsgType18>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType18" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType18() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType18" /> class.
        /// </summary>
        ...
        /// <param name="content">消息体 简单消息中文档相关字段全部为空 (required).</param>
        public MessageGetResMsgType18(string accessorname = default(string), AccessortypeEnum accessortype = default(AccessortypeEnum), long? csf = default(long?), string id = default(string), bool? isdir = default(bool?), bool? isread = default(bool?), string sender = default(string), long? time = default(long?), long? type = default(long?), string url = default(string), string content = default(string))
        {
        ...
        /// 消息体 简单消息中文档相关字段全部为空
        /// </summary>
        /// <value>消息体 简单消息中文档相关字段全部为空</value>
        ...
        {
            return this.Equals(input as MessageGetResMsgType18);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType18 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType18 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType18 input)
        {
            if (input == null)
                return false;
