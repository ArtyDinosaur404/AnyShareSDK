...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType30 :  IEquatable<MessageGetResMsgType30>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType30" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType30() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType30" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType30);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType30 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType30 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType30 input)
        {
            if (input == null)
                return false;
