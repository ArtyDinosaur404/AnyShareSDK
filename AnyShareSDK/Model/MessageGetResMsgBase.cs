...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgBase :  IEquatable<MessageGetResMsgBase>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        protected MessageGetResMsgBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgBase" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgBase);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgBase instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgBase input)
        {
            if (input == null)
                return false;
