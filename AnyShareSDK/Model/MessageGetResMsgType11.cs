...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType11 :  IEquatable<MessageGetResMsgType11>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType11" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType11() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType11" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType11);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType11 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType11 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType11 input)
        {
            if (input == null)
                return false;
