...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FileCopyReq :  IEquatable<FileCopyReq>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileCopyReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FileCopyReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FileCopyReq" /> class.
        /// </summary>
        /// <param name="docid">要复制的文件gns路径 (required).</param>
        /// <param name="destparent">目标父对象的gns路径 (required).</param>
        /// <param name="ondup">- 1:检查是否重命名，重名则抛异常  - 2:默认值，如果重名冲突，自动重名  - 3:如果重名冲突，自动覆盖  .</param>
        public FileCopyReq(string docid = default(string), string destparent = default(string), long? ondup = default(long?))
        {
            this.Docid = docid;
        ...
        {
            return this.Equals(input as FileCopyReq);
        }

        /// <summary>
        /// Returns true if FileCopyReq instances are equal
        /// </summary>
        /// <param name="input">Instance of FileCopyReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileCopyReq input)
        {
            if (input == null)
                return false;
