...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType1 :  IEquatable<MessageGetResMsgType1>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType1" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType1);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType1 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType1 input)
        {
            if (input == null)
                return false;
