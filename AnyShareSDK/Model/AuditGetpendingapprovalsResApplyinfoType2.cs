...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetpendingapprovalsResApplyinfoType2 :  IEquatable<AuditGetpendingapprovalsResApplyinfoType2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetpendingapprovalsResApplyinfoType2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType2" /> class.
        /// </summary>
        ...
        public AuditGetpendingapprovalsResApplyinfoType2(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), string sharername = default(string), long? createdate = default(long?), AuditGetapplysResApplyinfoType2AllOfDetail detail = default(AuditGetapplysResApplyinfoType2AllOfDetail))
        {
        ...
        public AuditGetapplysResApplyinfoType2AllOfDetail Detail { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditGetpendingapprovalsResApplyinfoType2 {\n");
        ...
        {
            return this.Equals(input as AuditGetpendingapprovalsResApplyinfoType2);
        }

        /// <summary>
        /// Returns true if AuditGetpendingapprovalsResApplyinfoType2 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetpendingapprovalsResApplyinfoType2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetpendingapprovalsResApplyinfoType2 input)
        {
            if (input == null)
                return false;
