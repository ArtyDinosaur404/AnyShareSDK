...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinkPlayinfoRes :  IEquatable<LinkPlayinfoRes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkPlayinfoRes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LinkPlayinfoRes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkPlayinfoRes" /> class.
        /// </summary>
        ...
        public LinkPlayinfoRes(long? status = default(long?), long? odstat = default(long?), long? sdstat = default(long?), string docid = default(string), long? remainingTime = default(long?))
        {
            this.Status = status;
            this.Odstat = odstat;
            this.Sdstat = sdstat;
        ...
        {
            return this.Equals(input as LinkPlayinfoRes);
        }

        /// <summary>
        /// Returns true if LinkPlayinfoRes instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkPlayinfoRes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkPlayinfoRes input)
        {
            if (input == null)
                return false;
