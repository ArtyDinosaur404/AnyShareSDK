...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinkListdirResFile :  IEquatable<LinkListdirResFile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkListdirResFile" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LinkListdirResFile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkListdirResFile" /> class.
        /// </summary>
        ...
        public LinkListdirResFile(long? clientMtime = default(long?), string docid = default(string), string name = default(string), string rev = default(string), long? size = default(long?), long? modified = default(long?))
        {
        ...
        {
            return this.Equals(input as LinkListdirResFile);
        }

        /// <summary>
        /// Returns true if LinkListdirResFile instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkListdirResFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkListdirResFile input)
        {
            if (input == null)
                return false;
