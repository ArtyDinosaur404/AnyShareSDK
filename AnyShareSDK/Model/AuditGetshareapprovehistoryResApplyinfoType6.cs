...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapprovehistoryResApplyinfoType6 :  IEquatable<AuditGetshareapprovehistoryResApplyinfoType6>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType6" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapprovehistoryResApplyinfoType6() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType6" /> class.
        /// </summary>
        ...
        public AuditGetshareapprovehistoryResApplyinfoType6(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?), string requestername = default(string), AuditGetshareapplyhistoryResApplyinfoType6AllOfDetail detail = default(AuditGetshareapplyhistoryResApplyinfoType6AllOfDetail))
        {
        ...
        public AuditGetshareapplyhistoryResApplyinfoType6AllOfDetail Detail { get; set; }
        ...
        {
            return this.Equals(input as AuditGetshareapprovehistoryResApplyinfoType6);
        }

        /// <summary>
        /// Returns true if AuditGetshareapprovehistoryResApplyinfoType6 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapprovehistoryResApplyinfoType6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapprovehistoryResApplyinfoType6 input)
        {
            if (input == null)
                return false;
