...
{
    /// <summary>
    /// MessageGetResMsgType24
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType24 :  IEquatable<MessageGetResMsgType24>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType24" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType24() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType24" /> class.
        /// </summary>
        ...
        public MessageGetResMsgType24(string accessorname = default(string), AccessortypeEnum accessortype = default(AccessortypeEnum), long? csf = default(long?), string id = default(string), bool? isdir = default(bool?), bool? isread = default(bool?), string sender = default(string), long? time = default(long?), long? type = default(long?), string url = default(string), long? allowvalue = default(long?), long? denyvalue = default(long?), long? end = default(long?), string taskdirname = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageGetResMsgType24 {\n");
        ...
        {
            return this.Equals(input as MessageGetResMsgType24);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType24 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType24 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType24 input)
        {
            if (input == null)
                return false;
