...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType23 :  IEquatable<MessageGetResMsgType23>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        protected MessageGetResMsgType23() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType23" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType23);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType23 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType23 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType23 input)
        {
            if (input == null)
                return false;
