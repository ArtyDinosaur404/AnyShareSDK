...
{
    /// <summary>
    /// MessageGetResMsgType20AllOf
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType20AllOf :  IEquatable<MessageGetResMsgType20AllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType20AllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType20AllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType20AllOf" /> class.
        /// </summary>
        ...
        public MessageGetResMsgType20AllOf(string auditorname = default(string), bool? auditresult = default(bool?), string auditmsg = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageGetResMsgType20AllOf {\n");
        ...
        {
            return this.Equals(input as MessageGetResMsgType20AllOf);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType20AllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType20AllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType20AllOf input)
        {
            if (input == null)
                return false;
