...
{
    /// <summary>
    /// 参见condition、value、lvalue、rvalue
    /// </summary>
    [DataContract]
    public partial class SearchSearchReqSize :  IEquatable<SearchSearchReqSize>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchSearchReqSize" /> class.
        /// </summary>
        ...
        public SearchSearchReqSize(string condition = default(string), long? value = default(long?), long? lvalue = default(long?), long? rvalue = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchSearchReqSize {\n");
        ...
        {
            return this.Equals(input as SearchSearchReqSize);
        }

        /// <summary>
        /// Returns true if SearchSearchReqSize instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchSearchReqSize to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchSearchReqSize input)
        {
            if (input == null)
                return false;
