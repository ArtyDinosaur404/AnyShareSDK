...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType10 :  IEquatable<MessageGetResMsgType10>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType10" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType10() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType10" /> class.
        /// </summary>
        ...
        public MessageGetResMsgType10(string accessorname = default(string), AccessortypeEnum accessortype = default(AccessortypeEnum), long? csf = default(long?), string id = default(string), bool? isdir = default(bool?), bool? isread = default(bool?), string sender = default(string), long? time = default(long?), long? type = default(long?), string url = default(string), long? allowvalue = default(long?), long? denyvalue = default(long?), long? end = default(long?), string auditorname = default(string), bool? auditresult = default(bool?), string auditmsg = default(string))
        {
        ...
        {
            return this.Equals(input as MessageGetResMsgType10);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType10 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType10 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType10 input)
        {
            if (input == null)
                return false;
