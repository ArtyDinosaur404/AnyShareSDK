...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvitationSetbaseinfoReq :  IEquatable<InvitationSetbaseinfoReq>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvitationSetbaseinfoReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvitationSetbaseinfoReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvitationSetbaseinfoReq" /> class.
        /// </summary>
        ...
        public InvitationSetbaseinfoReq(long? invitationendtime = default(long?), string invitationid = default(string), long? perm = default(long?), long? permendtime = default(long?))
        {
        ...
        {
            return this.Equals(input as InvitationSetbaseinfoReq);
        }

        /// <summary>
        /// Returns true if InvitationSetbaseinfoReq instances are equal
        /// </summary>
        /// <param name="input">Instance of InvitationSetbaseinfoReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvitationSetbaseinfoReq input)
        {
            if (input == null)
                return false;
