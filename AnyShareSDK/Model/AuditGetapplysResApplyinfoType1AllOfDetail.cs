...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetapplysResApplyinfoType1AllOfDetail :  IEquatable<AuditGetapplysResApplyinfoType1AllOfDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType1AllOfDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetapplysResApplyinfoType1AllOfDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType1AllOfDetail" /> class.
        /// </summary>
        ...
        public AuditGetapplysResApplyinfoType1AllOfDetail(string accessorid = default(string), string accessorname = default(string), long? accessortype = default(long?), long? allowvalue = default(long?), long? denyvalue = default(long?), long? endtime = default(long?), long? optype = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditGetapplysResApplyinfoType1AllOfDetail {\n");
        ...
        {
            return this.Equals(input as AuditGetapplysResApplyinfoType1AllOfDetail);
        }

        /// <summary>
        /// Returns true if AuditGetapplysResApplyinfoType1AllOfDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetapplysResApplyinfoType1AllOfDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetapplysResApplyinfoType1AllOfDetail input)
        {
            if (input == null)
                return false;
