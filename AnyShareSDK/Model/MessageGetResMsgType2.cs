...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType2 :  IEquatable<MessageGetResMsgType2>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        protected MessageGetResMsgType2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType2" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType2);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType2 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType2 input)
        {
            if (input == null)
                return false;
