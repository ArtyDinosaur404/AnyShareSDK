...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinkListdirResDir :  IEquatable<LinkListdirResDir>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkListdirResDir" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LinkListdirResDir() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkListdirResDir" /> class.
        /// </summary>
        ...
        public LinkListdirResDir(string docid = default(string), string name = default(string), string rev = default(string), long? size = default(long?), long? modified = default(long?))
        {
            this.Docid = docid;
            this.Name = name;
            this.Rev = rev;
        ...
        {
            return this.Equals(input as LinkListdirResDir);
        }

        /// <summary>
        /// Returns true if LinkListdirResDir instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkListdirResDir to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkListdirResDir input)
        {
            if (input == null)
                return false;
