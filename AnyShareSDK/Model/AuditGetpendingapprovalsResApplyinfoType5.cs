...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetpendingapprovalsResApplyinfoType5 :  IEquatable<AuditGetpendingapprovalsResApplyinfoType5>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType5" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetpendingapprovalsResApplyinfoType5() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType5" /> class.
        /// </summary>
        ...
        public AuditGetpendingapprovalsResApplyinfoType5(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), string sharername = default(string), long? createdate = default(long?), AuditGetapplysResApplyinfoType5AllOfDetail detail = default(AuditGetapplysResApplyinfoType5AllOfDetail))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditGetpendingapprovalsResApplyinfoType5 {\n");
        ...
        {
            return this.Equals(input as AuditGetpendingapprovalsResApplyinfoType5);
        }

        /// <summary>
        /// Returns true if AuditGetpendingapprovalsResApplyinfoType5 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetpendingapprovalsResApplyinfoType5 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetpendingapprovalsResApplyinfoType5 input)
        {
            if (input == null)
                return false;
