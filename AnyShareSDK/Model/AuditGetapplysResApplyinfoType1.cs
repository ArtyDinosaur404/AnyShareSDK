...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetapplysResApplyinfoType1 :  IEquatable<AuditGetapplysResApplyinfoType1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetapplysResApplyinfoType1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType1" /> class.
        /// </summary>
        ...
        public AuditGetapplysResApplyinfoType1(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), List<string> auditornames = default(List<string>), long? createdate = default(long?), AuditGetapplysResApplyinfoType1AllOfDetail detail = default(AuditGetapplysResApplyinfoType1AllOfDetail))
        {
        ...
        {
            return this.Equals(input as AuditGetapplysResApplyinfoType1);
        }

        /// <summary>
        /// Returns true if AuditGetapplysResApplyinfoType1 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetapplysResApplyinfoType1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetapplysResApplyinfoType1 input)
        {
            if (input == null)
                return false;
