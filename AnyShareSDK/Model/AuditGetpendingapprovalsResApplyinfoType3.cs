...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetpendingapprovalsResApplyinfoType3 :  IEquatable<AuditGetpendingapprovalsResApplyinfoType3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetpendingapprovalsResApplyinfoType3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType3" /> class.
        /// </summary>
        ...
        public AuditGetpendingapprovalsResApplyinfoType3(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), string sharername = default(string), long? createdate = default(long?), AuditGetapplysResApplyinfoType3AllOfDetail detail = default(AuditGetapplysResApplyinfoType3AllOfDetail))
        {
        ...
        public AuditGetapplysResApplyinfoType3AllOfDetail Detail { get; set; }
        ...
        {
            return this.Equals(input as AuditGetpendingapprovalsResApplyinfoType3);
        }

        /// <summary>
        /// Returns true if AuditGetpendingapprovalsResApplyinfoType3 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetpendingapprovalsResApplyinfoType3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetpendingapprovalsResApplyinfoType3 input)
        {
            if (input == null)
                return false;
