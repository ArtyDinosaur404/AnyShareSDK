...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DepartmentGetsubdepsResDepinfo :  IEquatable<DepartmentGetsubdepsResDepinfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartmentGetsubdepsResDepinfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DepartmentGetsubdepsResDepinfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartmentGetsubdepsResDepinfo" /> class.
        /// </summary>
        ...
        public DepartmentGetsubdepsResDepinfo(string depid = default(string), string name = default(string), bool? isconfigable = default(bool?))
        {
            this.Depid = depid;
            this.Name = name;
        ...
        {
            return this.Equals(input as DepartmentGetsubdepsResDepinfo);
        }

        /// <summary>
        /// Returns true if DepartmentGetsubdepsResDepinfo instances are equal
        /// </summary>
        /// <param name="input">Instance of DepartmentGetsubdepsResDepinfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepartmentGetsubdepsResDepinfo input)
        {
            if (input == null)
                return false;
