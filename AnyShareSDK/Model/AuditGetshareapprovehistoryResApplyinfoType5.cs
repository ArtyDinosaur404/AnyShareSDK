...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapprovehistoryResApplyinfoType5 :  IEquatable<AuditGetshareapprovehistoryResApplyinfoType5>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType5" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapprovehistoryResApplyinfoType5() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType5" /> class.
        /// </summary>
        ...
        public AuditGetshareapprovehistoryResApplyinfoType5(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?), string requestername = default(string), AuditGetshareapplyhistoryResApplyinfoType5AllOfDetail detail = default(AuditGetshareapplyhistoryResApplyinfoType5AllOfDetail))
        {
        ...
        public AuditGetshareapplyhistoryResApplyinfoType5AllOfDetail Detail { get; set; }
        ...
        {
            return this.Equals(input as AuditGetshareapprovehistoryResApplyinfoType5);
        }

        /// <summary>
        /// Returns true if AuditGetshareapprovehistoryResApplyinfoType5 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapprovehistoryResApplyinfoType5 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapprovehistoryResApplyinfoType5 input)
        {
            if (input == null)
                return false;
