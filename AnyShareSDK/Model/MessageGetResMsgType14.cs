...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType14 :  IEquatable<MessageGetResMsgType14>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        protected MessageGetResMsgType14() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType14" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType14);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType14 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType14 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType14 input)
        {
            if (input == null)
                return false;
