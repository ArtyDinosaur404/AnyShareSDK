...
{
    /// <summary>
    /// MessageGetResMsgType27
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType27 :  IEquatable<MessageGetResMsgType27>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType27" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType27() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType27" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType27);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType27 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType27 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType27 input)
        {
            if (input == null)
                return false;
