...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapplyhistoryResApplyinfoType5 :  IEquatable<AuditGetshareapplyhistoryResApplyinfoType5>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapplyhistoryResApplyinfoType5" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapplyhistoryResApplyinfoType5() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapplyhistoryResApplyinfoType5" /> class.
        /// </summary>
        ...
        public AuditGetshareapplyhistoryResApplyinfoType5(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?), AuditGetshareapplyhistoryResApplyinfoType5AllOfDetail detail = default(AuditGetshareapplyhistoryResApplyinfoType5AllOfDetail))
        {
        ...
        {
            return this.Equals(input as AuditGetshareapplyhistoryResApplyinfoType5);
        }

        /// <summary>
        /// Returns true if AuditGetshareapplyhistoryResApplyinfoType5 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapplyhistoryResApplyinfoType5 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapplyhistoryResApplyinfoType5 input)
        {
            if (input == null)
                return false;
