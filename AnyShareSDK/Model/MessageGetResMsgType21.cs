...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType21 :  IEquatable<MessageGetResMsgType21>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType21" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType21() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType21" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType21);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType21 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType21 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType21 input)
        {
            if (input == null)
                return false;
