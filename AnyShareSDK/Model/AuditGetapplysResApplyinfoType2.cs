...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetapplysResApplyinfoType2 :  IEquatable<AuditGetapplysResApplyinfoType2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetapplysResApplyinfoType2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType2" /> class.
        /// </summary>
        ...
        public AuditGetapplysResApplyinfoType2(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), List<string> auditornames = default(List<string>), long? createdate = default(long?), AuditGetapplysResApplyinfoType2AllOfDetail detail = default(AuditGetapplysResApplyinfoType2AllOfDetail))
        {
        ...
        {
            return this.Equals(input as AuditGetapplysResApplyinfoType2);
        }

        /// <summary>
        /// Returns true if AuditGetapplysResApplyinfoType2 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetapplysResApplyinfoType2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetapplysResApplyinfoType2 input)
        {
            if (input == null)
                return false;
