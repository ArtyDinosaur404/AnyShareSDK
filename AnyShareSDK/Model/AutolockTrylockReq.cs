...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AutolockTrylockReq :  IEquatable<AutolockTrylockReq>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutolockTrylockReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AutolockTrylockReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AutolockTrylockReq" /> class.
        /// </summary>
        ...
        public AutolockTrylockReq(string docid = default(string), bool? force = default(bool?), long? expiretime = default(long?))
        {
            this.Docid = docid;
            this.Force = force;
        ...
        {
            return this.Equals(input as AutolockTrylockReq);
        }

        /// <summary>
        /// Returns true if AutolockTrylockReq instances are equal
        /// </summary>
        /// <param name="input">Instance of AutolockTrylockReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AutolockTrylockReq input)
        {
            if (input == null)
                return false;
