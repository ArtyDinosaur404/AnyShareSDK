...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapplyhistoryResApplyinfoType6 :  IEquatable<AuditGetshareapplyhistoryResApplyinfoType6>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapplyhistoryResApplyinfoType6" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapplyhistoryResApplyinfoType6() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapplyhistoryResApplyinfoType6" /> class.
        /// </summary>
        ...
        public AuditGetshareapplyhistoryResApplyinfoType6(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?), AuditGetshareapplyhistoryResApplyinfoType6AllOfDetail detail = default(AuditGetshareapplyhistoryResApplyinfoType6AllOfDetail))
        {
        ...
        {
            return this.Equals(input as AuditGetshareapplyhistoryResApplyinfoType6);
        }

        /// <summary>
        /// Returns true if AuditGetshareapplyhistoryResApplyinfoType6 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapplyhistoryResApplyinfoType6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapplyhistoryResApplyinfoType6 input)
        {
            if (input == null)
                return false;
