...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetapplysResApplyinfoType3AllOfDetail :  IEquatable<AuditGetapplysResApplyinfoType3AllOfDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType3AllOfDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetapplysResApplyinfoType3AllOfDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType3AllOfDetail" /> class.
        /// </summary>
        ...
        public AuditGetapplysResApplyinfoType3AllOfDetail(string accessorid = default(string), string accessorname = default(string), long? accessortype = default(long?), long? endtime = default(long?), long? optype = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditGetapplysResApplyinfoType3AllOfDetail {\n");
        ...
        {
            return this.Equals(input as AuditGetapplysResApplyinfoType3AllOfDetail);
        }

        /// <summary>
        /// Returns true if AuditGetapplysResApplyinfoType3AllOfDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetapplysResApplyinfoType3AllOfDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetapplysResApplyinfoType3AllOfDetail input)
        {
            if (input == null)
                return false;
