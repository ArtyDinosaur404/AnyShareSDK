...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetapplysResApplyinfoType5AllOfDetail :  IEquatable<AuditGetapplysResApplyinfoType5AllOfDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType5AllOfDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetapplysResApplyinfoType5AllOfDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType5AllOfDetail" /> class.
        /// </summary>
        ...
        public AuditGetapplysResApplyinfoType5AllOfDetail(long? applycsflevel = default(long?), long? doccsflevel = default(long?), long? usercsflevel = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditGetapplysResApplyinfoType5AllOfDetail {\n");
        ...
        {
            return this.Equals(input as AuditGetapplysResApplyinfoType5AllOfDetail);
        }

        /// <summary>
        /// Returns true if AuditGetapplysResApplyinfoType5AllOfDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetapplysResApplyinfoType5AllOfDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetapplysResApplyinfoType5AllOfDetail input)
        {
            if (input == null)
                return false;
