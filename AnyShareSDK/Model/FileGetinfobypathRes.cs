...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FileGetinfobypathRes :  IEquatable<FileGetinfobypathRes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileGetinfobypathRes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FileGetinfobypathRes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FileGetinfobypathRes" /> class.
        /// </summary>
        /// <param name="docid">文件/目录的gns路径 (required).</param>
        /// <param name="name">文件/目录的名称，UTF8编码 (required).</param>
        /// <param name="rev">文件版本号或目录数据变化标识 (required).</param>
        ...
        public FileGetinfobypathRes(string docid = default(string), string name = default(string), string rev = default(string), long? size = default(long?), long? modified = default(long?), long? clientMtime = default(long?))
        {
            this.Docid = docid;
            this.Name = name;
            this.Rev = rev;
        ...
        {
            return this.Equals(input as FileGetinfobypathRes);
        }

        /// <summary>
        /// Returns true if FileGetinfobypathRes instances are equal
        /// </summary>
        /// <param name="input">Instance of FileGetinfobypathRes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileGetinfobypathRes input)
        {
            if (input == null)
                return false;
