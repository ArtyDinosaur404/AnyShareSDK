...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType28 :  IEquatable<MessageGetResMsgType28>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        protected MessageGetResMsgType28() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType28" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType28);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType28 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType28 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType28 input)
        {
            if (input == null)
                return false;
