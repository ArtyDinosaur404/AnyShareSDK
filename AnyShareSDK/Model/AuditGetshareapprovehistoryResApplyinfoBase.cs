...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapprovehistoryResApplyinfoBase :  IEquatable<AuditGetshareapprovehistoryResApplyinfoBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapprovehistoryResApplyinfoBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoBase" /> class.
        /// </summary>
        ...
        public AuditGetshareapprovehistoryResApplyinfoBase(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?), string requestername = default(string))
        {
        ...
        {
            return this.Equals(input as AuditGetshareapprovehistoryResApplyinfoBase);
        }

        /// <summary>
        /// Returns true if AuditGetshareapprovehistoryResApplyinfoBase instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapprovehistoryResApplyinfoBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapprovehistoryResApplyinfoBase input)
        {
            if (input == null)
                return false;
