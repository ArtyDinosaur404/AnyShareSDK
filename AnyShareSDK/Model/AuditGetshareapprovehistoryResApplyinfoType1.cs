...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapprovehistoryResApplyinfoType1 :  IEquatable<AuditGetshareapprovehistoryResApplyinfoType1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapprovehistoryResApplyinfoType1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType1" /> class.
        /// </summary>
        ...
        public AuditGetshareapprovehistoryResApplyinfoType1(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?), string requestername = default(string), AuditGetshareapplyhistoryResApplyinfoType1AllOfDetail detail = default(AuditGetshareapplyhistoryResApplyinfoType1AllOfDetail))
        {
        ...
        {
            return this.Equals(input as AuditGetshareapprovehistoryResApplyinfoType1);
        }

        /// <summary>
        /// Returns true if AuditGetshareapprovehistoryResApplyinfoType1 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapprovehistoryResApplyinfoType1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapprovehistoryResApplyinfoType1 input)
        {
            if (input == null)
                return false;
