...
{
    /// <summary>
    /// MessageGetResMsgType22
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType22 :  IEquatable<MessageGetResMsgType22>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        protected MessageGetResMsgType22() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType22" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType22);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType22 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType22 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType22 input)
        {
            if (input == null)
                return false;
