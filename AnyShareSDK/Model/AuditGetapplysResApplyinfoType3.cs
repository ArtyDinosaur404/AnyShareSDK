...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetapplysResApplyinfoType3 :  IEquatable<AuditGetapplysResApplyinfoType3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetapplysResApplyinfoType3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType3" /> class.
        /// </summary>
        ...
        public AuditGetapplysResApplyinfoType3(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), List<string> auditornames = default(List<string>), long? createdate = default(long?), AuditGetapplysResApplyinfoType3AllOfDetail detail = default(AuditGetapplysResApplyinfoType3AllOfDetail))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditGetapplysResApplyinfoType3 {\n");
        ...
        {
            return this.Equals(input as AuditGetapplysResApplyinfoType3);
        }

        /// <summary>
        /// Returns true if AuditGetapplysResApplyinfoType3 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetapplysResApplyinfoType3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetapplysResApplyinfoType3 input)
        {
            if (input == null)
                return false;
