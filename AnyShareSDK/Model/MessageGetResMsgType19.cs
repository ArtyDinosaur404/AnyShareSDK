...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType19 :  IEquatable<MessageGetResMsgType19>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType19" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType19() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType19" /> class.
        /// </summary>
        ...
        public MessageGetResMsgType19(string accessorname = default(string), AccessortypeEnum accessortype = default(AccessortypeEnum), long? csf = default(long?), string id = default(string), bool? isdir = default(bool?), bool? isread = default(bool?), string sender = default(string), long? time = default(long?), long? type = default(long?), string url = default(string), long? applycsflevel = default(long?))
        {
        ...
        {
            return this.Equals(input as MessageGetResMsgType19);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType19 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType19 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType19 input)
        {
            if (input == null)
                return false;
