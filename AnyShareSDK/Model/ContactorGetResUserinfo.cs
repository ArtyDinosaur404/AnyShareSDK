...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContactorGetResUserinfo :  IEquatable<ContactorGetResUserinfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactorGetResUserinfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContactorGetResUserinfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactorGetResUserinfo" /> class.
        /// </summary>
        ...
        public ContactorGetResUserinfo(string userid = default(string), string account = default(string), string name = default(string), string mail = default(string), long? csflevel = default(long?))
        {
            this.Userid = userid;
        ...
        {
            return this.Equals(input as ContactorGetResUserinfo);
        }

        /// <summary>
        /// Returns true if ContactorGetResUserinfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ContactorGetResUserinfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContactorGetResUserinfo input)
        {
            if (input == null)
                return false;
