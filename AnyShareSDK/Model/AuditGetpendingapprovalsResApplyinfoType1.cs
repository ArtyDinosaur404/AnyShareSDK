...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetpendingapprovalsResApplyinfoType1 :  IEquatable<AuditGetpendingapprovalsResApplyinfoType1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType1" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetpendingapprovalsResApplyinfoType1() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetpendingapprovalsResApplyinfoType1" /> class.
        /// </summary>
        ...
        public AuditGetpendingapprovalsResApplyinfoType1(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), string sharername = default(string), long? createdate = default(long?), AuditGetapplysResApplyinfoType1AllOfDetail detail = default(AuditGetapplysResApplyinfoType1AllOfDetail))
        {
        ...
        public AuditGetapplysResApplyinfoType1AllOfDetail Detail { get; set; }
        ...
        {
            return this.Equals(input as AuditGetpendingapprovalsResApplyinfoType1);
        }

        /// <summary>
        /// Returns true if AuditGetpendingapprovalsResApplyinfoType1 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetpendingapprovalsResApplyinfoType1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetpendingapprovalsResApplyinfoType1 input)
        {
            if (input == null)
                return false;
