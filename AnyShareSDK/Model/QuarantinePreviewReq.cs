...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuarantinePreviewReq :  IEquatable<QuarantinePreviewReq>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuarantinePreviewReq" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuarantinePreviewReq() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuarantinePreviewReq" /> class.
        /// </summary>
        /// <param name="docid">文件docid (required).</param>
        /// <param name="rev">预览版本ID （不可为空） (required).</param>
        /// <param name="reqhost">从存储服务器下载数据时的请求地址从存储服务器下载数据时的请求地址.</param>
        /// <param name="usehttps">是否使用https下载数据，默认为true.</param>
        public QuarantinePreviewReq(string docid = default(string), string rev = default(string), string reqhost = default(string), bool? usehttps = default(bool?))
        {
            this.Docid = docid;
            this.Rev = rev;
        ...
        /// </summary>
        /// <value>从存储服务器下载数据时的请求地址从存储服务器下载数据时的请求地址</value>
        ...
        {
            return this.Equals(input as QuarantinePreviewReq);
        }

        /// <summary>
        /// Returns true if QuarantinePreviewReq instances are equal
        /// </summary>
        /// <param name="input">Instance of QuarantinePreviewReq to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuarantinePreviewReq input)
        {
            if (input == null)
                return false;
