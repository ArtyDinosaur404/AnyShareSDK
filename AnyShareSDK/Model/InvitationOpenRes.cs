...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvitationOpenRes :  IEquatable<InvitationOpenRes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvitationOpenRes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvitationOpenRes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvitationOpenRes" /> class.
        /// </summary>
        ...
        public InvitationOpenRes(long? invitationendtime = default(long?), string invitationid = default(string), long? perm = default(long?), long? permendtime = default(long?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvitationOpenRes {\n");
        ...
        {
            return this.Equals(input as InvitationOpenRes);
        }

        /// <summary>
        /// Returns true if InvitationOpenRes instances are equal
        /// </summary>
        /// <param name="input">Instance of InvitationOpenRes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvitationOpenRes input)
        {
            if (input == null)
                return false;
