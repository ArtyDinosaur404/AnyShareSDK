...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetapplysResApplyinfoType6 :  IEquatable<AuditGetapplysResApplyinfoType6>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType6" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetapplysResApplyinfoType6() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoType6" /> class.
        /// </summary>
        ...
        public AuditGetapplysResApplyinfoType6(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), List<string> auditornames = default(List<string>), long? createdate = default(long?), AuditGetapplysResApplyinfoType6AllOfDetail detail = default(AuditGetapplysResApplyinfoType6AllOfDetail))
        {
        ...
        {
            return this.Equals(input as AuditGetapplysResApplyinfoType6);
        }

        /// <summary>
        /// Returns true if AuditGetapplysResApplyinfoType6 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetapplysResApplyinfoType6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetapplysResApplyinfoType6 input)
        {
            if (input == null)
                return false;
