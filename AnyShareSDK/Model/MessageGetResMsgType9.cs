...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType9 :  IEquatable<MessageGetResMsgType9>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType9" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType9() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType9" /> class.
        /// </summary>
        ...
        public MessageGetResMsgType9(string accessorname = default(string), AccessortypeEnum accessortype = default(AccessortypeEnum), long? csf = default(long?), string id = default(string), bool? isdir = default(bool?), bool? isread = default(bool?), string sender = default(string), long? time = default(long?), long? type = default(long?), string url = default(string), long? end = default(long?), long? perm = default(long?))
        {
        ...
        {
            return this.Equals(input as MessageGetResMsgType9);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType9 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType9 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType9 input)
        {
            if (input == null)
                return false;
