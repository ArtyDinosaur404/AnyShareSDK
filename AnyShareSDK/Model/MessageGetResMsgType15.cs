...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType15 :  IEquatable<MessageGetResMsgType15>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        protected MessageGetResMsgType15() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType15" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType15);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType15 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType15 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType15 input)
        {
            if (input == null)
                return false;
