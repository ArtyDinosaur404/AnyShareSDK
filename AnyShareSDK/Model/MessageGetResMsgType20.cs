...
{
    /// <summary>
    /// MessageGetResMsgType20
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType20 :  IEquatable<MessageGetResMsgType20>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType20" /> class.
        /// </summary>
        ...
        public MessageGetResMsgType20(string accessorname = default(string), AccessortypeEnum accessortype = default(AccessortypeEnum), long? csf = default(long?), string id = default(string), bool? isdir = default(bool?), bool? isread = default(bool?), string sender = default(string), long? time = default(long?), long? type = default(long?), string url = default(string), string auditorname = default(string), bool? auditresult = default(bool?), string auditmsg = default(string))
        {
        ...
        {
            return this.Equals(input as MessageGetResMsgType20);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType20 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType20 input)
        {
            if (input == null)
                return false;
