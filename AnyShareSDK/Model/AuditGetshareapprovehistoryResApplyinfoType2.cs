...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapprovehistoryResApplyinfoType2 :  IEquatable<AuditGetshareapprovehistoryResApplyinfoType2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapprovehistoryResApplyinfoType2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType2" /> class.
        /// </summary>
        ...
        /// <param name="requestername">共享者名称 (required).</param>
        /// <param name="detail">detail.</param>
        public AuditGetshareapprovehistoryResApplyinfoType2(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?), string requestername = default(string), AuditGetshareapplyhistoryResApplyinfoType2AllOfDetail detail = default(AuditGetshareapplyhistoryResApplyinfoType2AllOfDetail))
        {
        ...
        public AuditGetshareapplyhistoryResApplyinfoType2AllOfDetail Detail { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditGetshareapprovehistoryResApplyinfoType2 {\n");
        ...
        {
            return this.Equals(input as AuditGetshareapprovehistoryResApplyinfoType2);
        }

        /// <summary>
        /// Returns true if AuditGetshareapprovehistoryResApplyinfoType2 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapprovehistoryResApplyinfoType2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapprovehistoryResApplyinfoType2 input)
        {
            if (input == null)
                return false;
