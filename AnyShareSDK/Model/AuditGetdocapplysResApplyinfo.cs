...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetdocapplysResApplyinfo :  IEquatable<AuditGetdocapplysResApplyinfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetdocapplysResApplyinfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetdocapplysResApplyinfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetdocapplysResApplyinfo" /> class.
        /// </summary>
        ...
        public AuditGetdocapplysResApplyinfo(string applyid = default(string), string applymsg = default(string), List<string> auditornames = default(List<string>), long? auditprogress = default(long?), long? audittype = default(long?), long? createdate = default(long?), long? csflevel = default(long?), string docid = default(string), string docname = default(string), bool? isdir = default(bool?), string processname = default(string))
        {
        ...
        {
            return this.Equals(input as AuditGetdocapplysResApplyinfo);
        }

        /// <summary>
        /// Returns true if AuditGetdocapplysResApplyinfo instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetdocapplysResApplyinfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetdocapplysResApplyinfo input)
        {
            if (input == null)
                return false;
