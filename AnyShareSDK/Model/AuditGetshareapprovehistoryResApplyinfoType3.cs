...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapprovehistoryResApplyinfoType3 :  IEquatable<AuditGetshareapprovehistoryResApplyinfoType3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType3" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapprovehistoryResApplyinfoType3() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapprovehistoryResApplyinfoType3" /> class.
        /// </summary>
        ...
        public AuditGetshareapprovehistoryResApplyinfoType3(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?), string requestername = default(string), AuditGetshareapplyhistoryResApplyinfoType3AllOfDetail detail = default(AuditGetshareapplyhistoryResApplyinfoType3AllOfDetail))
        {
        ...
        {
            return this.Equals(input as AuditGetshareapprovehistoryResApplyinfoType3);
        }

        /// <summary>
        /// Returns true if AuditGetshareapprovehistoryResApplyinfoType3 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapprovehistoryResApplyinfoType3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapprovehistoryResApplyinfoType3 input)
        {
            if (input == null)
                return false;
