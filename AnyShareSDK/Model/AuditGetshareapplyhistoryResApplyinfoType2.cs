...
{
    /// <summary>
    /// AuditGetshareapplyhistoryResApplyinfoType2
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapplyhistoryResApplyinfoType2 :  IEquatable<AuditGetshareapplyhistoryResApplyinfoType2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapplyhistoryResApplyinfoType2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapplyhistoryResApplyinfoType2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapplyhistoryResApplyinfoType2" /> class.
        /// </summary>
        ...
        public AuditGetshareapplyhistoryResApplyinfoType2(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?), AuditGetshareapplyhistoryResApplyinfoType2AllOfDetail detail = default(AuditGetshareapplyhistoryResApplyinfoType2AllOfDetail))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditGetshareapplyhistoryResApplyinfoType2 {\n");
        ...
        {
            return this.Equals(input as AuditGetshareapplyhistoryResApplyinfoType2);
        }

        /// <summary>
        /// Returns true if AuditGetshareapplyhistoryResApplyinfoType2 instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapplyhistoryResApplyinfoType2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapplyhistoryResApplyinfoType2 input)
        {
            if (input == null)
                return false;
