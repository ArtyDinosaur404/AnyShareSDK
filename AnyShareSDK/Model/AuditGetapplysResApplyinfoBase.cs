...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetapplysResApplyinfoBase :  IEquatable<AuditGetapplysResApplyinfoBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetapplysResApplyinfoBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetapplysResApplyinfoBase" /> class.
        /// </summary>
        ...
        public AuditGetapplysResApplyinfoBase(string applyid = default(string), string docid = default(string), string docname = default(string), long? apptype = default(long?), bool? isdir = default(bool?), long? csflevel = default(long?), List<string> auditornames = default(List<string>), long? createdate = default(long?))
        {
        ...
        {
            return this.Equals(input as AuditGetapplysResApplyinfoBase);
        }

        /// <summary>
        /// Returns true if AuditGetapplysResApplyinfoBase instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetapplysResApplyinfoBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetapplysResApplyinfoBase input)
        {
            if (input == null)
                return false;
