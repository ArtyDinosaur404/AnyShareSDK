...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SearchSearchReqCreatetime :  IEquatable<SearchSearchReqCreatetime>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchSearchReqCreatetime" /> class.
        /// </summary>
        ...
        public SearchSearchReqCreatetime(string condition = default(string), long? value = default(long?), long? lvalue = default(long?), long? rvalue = default(long?))
        {
        ...
        {
            return this.Equals(input as SearchSearchReqCreatetime);
        }

        /// <summary>
        /// Returns true if SearchSearchReqCreatetime instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchSearchReqCreatetime to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchSearchReqCreatetime input)
        {
            if (input == null)
                return false;
