...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Auth1GetnewReqDeviceinfo :  IEquatable<Auth1GetnewReqDeviceinfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Auth1GetnewReqDeviceinfo" /> class.
        /// </summary>
        ...
        public Auth1GetnewReqDeviceinfo(string name = default(string), long? ostype = default(long?), string devicetype = default(string), string udid = default(string), string version = default(string))
        {
            this.Name = name;
            this.Ostype = ostype;
        ...
        {
            return this.Equals(input as Auth1GetnewReqDeviceinfo);
        }

        /// <summary>
        /// Returns true if Auth1GetnewReqDeviceinfo instances are equal
        /// </summary>
        /// <param name="input">Instance of Auth1GetnewReqDeviceinfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Auth1GetnewReqDeviceinfo input)
        {
            if (input == null)
                return false;
