...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DepartmentGetsubusersResUserinfo :  IEquatable<DepartmentGetsubusersResUserinfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartmentGetsubusersResUserinfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DepartmentGetsubusersResUserinfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartmentGetsubusersResUserinfo" /> class.
        /// </summary>
        ...
        public DepartmentGetsubusersResUserinfo(string userid = default(string), string account = default(string), string name = default(string), string mail = default(string), long? csflevel = default(long?))
        {
            this.Userid = userid;
        ...
        {
            return this.Equals(input as DepartmentGetsubusersResUserinfo);
        }

        /// <summary>
        /// Returns true if DepartmentGetsubusersResUserinfo instances are equal
        /// </summary>
        /// <param name="input">Instance of DepartmentGetsubusersResUserinfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepartmentGetsubusersResUserinfo input)
        {
            if (input == null)
                return false;
