...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MessageGetResMsgType12 :  IEquatable<MessageGetResMsgType12>, IValidatableObject
    {
        /// <summary>
        /// 表示访问者类型
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType12" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MessageGetResMsgType12() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageGetResMsgType12" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MessageGetResMsgType12);
        }

        /// <summary>
        /// Returns true if MessageGetResMsgType12 instances are equal
        /// </summary>
        /// <param name="input">Instance of MessageGetResMsgType12 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageGetResMsgType12 input)
        {
            if (input == null)
                return false;
