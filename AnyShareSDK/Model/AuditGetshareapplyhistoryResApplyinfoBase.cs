...
namespace AnyShareSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditGetshareapplyhistoryResApplyinfoBase :  IEquatable<AuditGetshareapplyhistoryResApplyinfoBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapplyhistoryResApplyinfoBase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditGetshareapplyhistoryResApplyinfoBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditGetshareapplyhistoryResApplyinfoBase" /> class.
        /// </summary>
        ...
        public AuditGetshareapplyhistoryResApplyinfoBase(long? approveindex = default(long?), List<string> auditornames = default(List<string>), long? csflevel = default(long?), string docname = default(string), bool? isdir = default(bool?), long? requestdate = default(long?), long? vetoindex = default(long?), long? apptype = default(long?))
        {
        ...
        {
            return this.Equals(input as AuditGetshareapplyhistoryResApplyinfoBase);
        }

        /// <summary>
        /// Returns true if AuditGetshareapplyhistoryResApplyinfoBase instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditGetshareapplyhistoryResApplyinfoBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditGetshareapplyhistoryResApplyinfoBase input)
        {
            if (input == null)
                return false;
