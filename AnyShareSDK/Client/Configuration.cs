...
namespace AnyShareSDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "OpenAPI-Generator/6.0.10/csharp";
            BasePath = "https://host:443/api/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://host:443/api/v1") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/6.0.10/csharp"
        ...
        {
            String report = "C# SDK (IO.OpenDocAPI) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 6.0.10\n";
        ...
        /// <summary>
        /// sets the SSL validate.
        /// </summary>
        /// <param name="flag"></param>
        /// <returns>false if you don't want a SSL validate. default is true</returns>
        public void SetVerifyingSsl(bool flag)
        {
            if (!flag)
            {
